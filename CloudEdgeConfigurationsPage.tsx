                ...
                {config.type !== 'ready-plan' && (
                    <>
                        <CollapsibleSection title="Advanced Settings & Optional Resources" initialOpen={false}>
                            ...
                            <FormField type="checkbox" id="confidentialVM" name="confidentialVM" label="Enable Confidential VM Service" value="confidentialVM" checked={!!config.confidentialVM} onChange={handleChange} hint="Note: Compatibility and pricing vary."/>
                            <FormField type="checkbox" id="addGPUs" name="addGPUs" label="Add GPUs" value="addGPUs" checked={!!config.addGPUs} onChange={handleChange} />
                            {config.addGPUs && (
                        ...
                        <CollapsibleSection title="Add-ons (Monthly)" initialOpen={false}>
                            <FormField type="checkbox" id="advancedFirewall" name="advancedFirewall" label={`Advanced Firewall Service (+$${PRICE_ADVANCED_FIREWALL_MONTHLY.toFixed(2)})`} value="advancedFirewall" checked={!!config.advancedFirewall} onChange={handleChange}/>
                            <FormField type="checkbox" id="enhancedMonitoring" name="enhancedMonitoring" label={`Enhanced Monitoring Suite (+$${PRICE_ENHANCED_MONITORING_MONTHLY.toFixed(2)})`} value="enhancedMonitoring" checked={!!config.enhancedMonitoring} onChange={handleChange}/>
                        </CollapsibleSection>
                    </>
                )}
