                    ...
                    <div className="lg:col-span-8 space-y-12 pb-24">
                        ...
                        <section className="space-y-8">
                            ...
                            {config.type === 'instance' && (
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end p-6 !bg-gray-50/50 dark:!bg-slate-900/20 border border-gray-100 dark:border-slate-800 rounded-xl shadow-sm">
                        ...
                        {config.type !== 'ready-plan' && (
                            <section className="space-y-6">
                                ...
                                <CollapsibleSection title="Enterprise Extensions (Managed Services)">
