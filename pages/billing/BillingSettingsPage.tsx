...
export const SubscriptionsListView: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (newSubs.length > 0) {
            ...
            const filteredNewSubs = newSubs.filter((ns: Subscription) => !mockSubscriptions.some(ms => ms.id === ns.id));
            setSubscriptions([...mockSubscriptions, ...filteredNewSubs]);
        }
    }, []);
                    ...
                    <table className="min-w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            {subscriptions.map(sub => {
                                ...
                                const isBundle = sub.bundledPlans && sub.bundledPlans.length > 0;
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex flex-col">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        {isBundle && (
                                                            <span className="bg-amber-100 text-amber-700 text-[8px] px-1.5 py-0.5 rounded font-black uppercase tracking-tighter">Bundle</span>
                                                        )}
                                                    </div>
                                                    ...
                                                    {isBundle && (
                                                        <div className="flex flex-wrap gap-1 mt-1.5">
                                                            {sub.bundledPlans?.map((p, idx) => (
                                                                <span key={idx} className="text-[10px] bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-gray-400 px-1.5 py-0.5 rounded border border-gray-200 dark:border-slate-600">
                                                                    {p.planName.replace('Posta ', '')} ({p.quantity})
                                                                </span>
                                                            ))}
                                                        </div>
                                                    )}
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <div className="w-16 h-16 rounded-2xl bg-white dark:bg-slate-700 shadow-sm flex items-center justify-center mb-6 transition-transform group-hover:scale-110 p-2">
                                <img src="https://www.worldposta.com/assets/Posta-Logo.avif" alt="Posta Logo" className="w-full h-auto object-contain" />
                            </div>
