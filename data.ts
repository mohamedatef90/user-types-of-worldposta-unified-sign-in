...
export const MOCK_USERS: { [email: string]: User & { passwordHash: string } } = {
  ...
  "superadmin@worldposta.com": {
    id: "superadmin001",
    fullName: "Super Admin",
    email: "superadmin@worldposta.com",
    companyName: "WorldPosta HQ",
    displayName: "SuperAdmin HQ",
    avatarUrl: "https://picsum.photos/seed/superadmin001/100/100",
    passwordHash: "hashedpassword_super_admin",
    role: "super_admin",
